...
<body>
  ...
  <h2 class="sub-heading">Student Expenses</h2>
  	<a class="_btn checkout-btn entypo-forward" href="Overview">Back</a>
 		<!-- <button class="_btn checkout-btn entypo-forward" style="margin-left: 191px;margin-top: -70px;position: absolute;">Back</button>-->
  ...
  <section class="shopping-cart">
    ...
    <footer class="_grid cart-totals">
      <div class="_column subtotal" id="subtotalCtr">
        ...
        <div class="cart-totals-value">${amount}</div>
      </div>
      ...
      <div class="_column taxes" id="taxesCtr">
        ...
        <div class="cart-totals-value">${((6/100)*amount)}</div>
      </div>
      <div class="_column total" id="totalCtr">
        <div class="cart-totals-key">Total</div>
        <div class="cart-totals-value">${amount+((6/100)*amount)}</div>
      </div>
      <div class="_column checkout">
        <button class="_btn checkout-btn entypo-forward" onclick="submitValue()">PAYDUES</button>
      </div>
    </footer>
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/zepto/1.0/zepto.min.js'></script>
    ...
    <script src="js/index.js"></script>
		<form:form action="savingPaymentDetails" commandName="bom" id="imageform" modelAttribute="bom">
		</form:form>
