...
<html lang="en">
	...
	<h3  style="margin-left: 555px;">Meal Management System.</h3>
	...
	<c:set var="count" value="0" scope="page" />	
	    <c:forEach  items="${userdetails}" var="article">
				<tr>
					...
					<td> <input type="text" name="TextBox" id="TextBox${count}" value='<c:out  value="${article.attendence}" />' /></td>
	...
	<form:form action="messdetails" commandName="Mess" id="imageform" modelAttribute="Mess">
		<div class="login">
		...
		$(function(){
		 ...
		 var countData=0;
	        <c:forEach var="article" items="${userdetails}">
	            ...
	            attendence.push(document.getElementById(idValue).value);
